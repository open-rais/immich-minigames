...
// Small pure helpers shared between TimelineGame.tsx (live play) and TimelineRounds.tsx ("Ver
// rondas") - both need the same board bookkeeping, so this lives once inside the Timeline package
// instead of being copy-pasted (this project avoids sharing logic across DIFFERENT games, not
// within the same one).
...
// always contains correctSlot, so a rejected guess can't be it.
