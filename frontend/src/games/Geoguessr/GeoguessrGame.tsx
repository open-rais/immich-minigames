...
import { assetThumbnailUrl, playGeoguessrRound } from "../../api/games"
...
function isGeoguessrRound(round: RoundOut): round is GeoguessrRoundOut {
  return round.game_type === "geoguessr"
}
...
export function GeoguessrGame() {
  ...
  >({
    ...
    playRound: (gameId, roundId, guess) => playGeoguessrRound(gameId, roundId, guess.lat, guess.lng),
